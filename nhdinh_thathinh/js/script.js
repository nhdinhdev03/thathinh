...
function troll() {
    ...
    const y = document.getElementById("fbut3");
      ...
      document.getElementById("alert2").innerHTML = "em mà thoát trang Web này hay là em đồng ý nha 😛";
      document.getElementById("audio2").play();
      return false;
}
function troll1() {
...
function inrel() {
    ...
    const b = document.getElementById("fbut2alt");
     ...
     document.getElementById("des").innerHTML = "Nếu em không phiền thì làm người yêu anh nhé 😳";
     return false;
